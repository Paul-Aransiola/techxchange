...
export const NEWS_API_KEY = process.env.NEWS_API_KEY || 'pub_0415058b7ace4e3286a71c67a7584956';
export const NEWS_API_BASE_URL = process.env.NEWS_API_BASE_URL || 'https://newsdata.io/api/1';
